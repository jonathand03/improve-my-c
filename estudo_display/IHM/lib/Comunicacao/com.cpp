...
uint8_t SerialCom::SerialWrite(uint8_t *package)
{
    ...
    this->SerialConfiguration.PackageSize = sizeof(this->SerialConfiguration.StreamPackage);
    if(this->SerialConfiguration.IsWorking == true)
    {
        Serial.write(this->SerialConfiguration.StreamPackage,this->SerialConfiguration.PackageSize);
    }
